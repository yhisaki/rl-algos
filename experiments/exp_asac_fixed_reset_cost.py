...
import wandb
from rl_algos.agents.research import ASACFixedResetCost
...
def train_asac_fixed_reset_cost():
    ...
    wandb.init(
        ...
        tags=["asac_fixed_reset_cost", args.env_id],
        config=args,
        group=args.group,
    )
