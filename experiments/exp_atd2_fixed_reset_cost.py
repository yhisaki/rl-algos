...
import wandb
from rl_algos.agents.research import ATD2FixedResetCost
...
def train_atd2_fixed_reset_cost():
    ...
    wandb.init(
        ...
        tags=["atd2_fixed_reset_cost", args.env_id],
        config=args,
        group=args.group,
    )
